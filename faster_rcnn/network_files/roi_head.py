...
class RoIHeads(torch.nn.Module):
    ...
    def assign_targets_to_proposals(self, proposals, gt_boxes, gt_labels):
        ...
        for proposals_in_image, gt_boxes_in_image, gt_labels_in_image in zip(proposals, gt_boxes, gt_labels):
            if gt_boxes_in_image.numel() == 0:  # 该张图像中没有gt框，为背景
                ...
                # iou < low_threshold索引值为 -1，>=0.5索引不变
    ...
    def select_training_samples(self,
        ...
        # 将gt_boxes拼接到proposal后面（目的应该是增加正样本数）
        ...
        # 根据gt和proposal计算边框回归参数（针对gt的）    这里是真实的边界框回归参数
    ...
    def forward(self,
        ...
        if self.training:
            # 划分正负样本，统计对应gt的标签以及边界框回归信息 512个
            #proposals[512,4]
        ...
        # box_features_shape: [b*num_proposals, channel, height, width]
        ...
        # 接着分别预测目标类别和边界框回归参数
        #class_logits[4096,21] box_regression[4096,84]
